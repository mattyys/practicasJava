...
public class Mazo {
	...
	public void ordenar() {
		...
		do {
			...
			System.out.println("1.Ordena el mazo por Numero incremantal y luego por palo.");
			System.out.println("2.Ordena el mazo por PALO y luego por numero Decremental.");
			System.out.println("3.Ordena el mazo por PALO y luego por numero incremental.");
